...
import Peminjam.DashboardPeminjam;
...
public class LoginPage extends javax.swing.JFrame {
    ...
    private void performLogin() {
        ...
        try {
            ...
            if (conn == null) {
                JOptionPane.showMessageDialog(this, 
                    "Koneksi database gagal! Pastikan MySQL sudah berjalan.", 
                    "Error Database", 
                    JOptionPane.ERROR_MESSAGE);
                return;
            }
            
            // Query untuk login (username bisa NIM atau email)
            // Gunakan TRIM untuk menghilangkan spasi dan case-insensitive comparison
            String query = "SELECT * FROM users WHERE (TRIM(NIM) = TRIM(?) OR TRIM(email) = TRIM(?)) AND password = ?";
            ...
            if (rs.next()) {
                ...
                } else if ("peminjam".equalsIgnoreCase(role)) {
    ...
    private void initComponents() {
        ...
        gridBagConstraints.anchor = java.awt.GridBagConstraints.NORTHWEST;
        gridBagConstraints.insets = new java.awt.Insets(6, 38, 150, 0);
        ...
        gridBagConstraints.anchor = java.awt.GridBagConstraints.NORTHWEST;
        gridBagConstraints.insets = new java.awt.Insets(56, 61, 0, 140);
        ...
        gridBagConstraints.anchor = java.awt.GridBagConstraints.NORTHWEST;
        gridBagConstraints.insets = new java.awt.Insets(18, 61, 94, 0);
    ...
    private void jPasswordField1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jPasswordField1ActionPerformed
        // TODO add your handling code here:
        performLogin(); // Login saat tekan Enter di password field
    }//GEN-LAST:event_jPasswordField1ActionPerformed

    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        // TODO add your handling code here:
        performLogin(); // Login saat klik tombol Masuk
    }//GEN-LAST:event_jButton1ActionPerformed

    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        // Toggle show/hide password
        if (jPasswordField1.getEchoChar() == (char) 0) {
            // Password sedang terlihat, sembunyikan
            jPasswordField1.setEchoChar('•');
            jButton2.setText("Lihat Password");
        } else {
            // Password tersembunyi, tampilkan
            jPasswordField1.setEchoChar((char) 0);
            jButton2.setText("Sembunyikan Password");
        }
